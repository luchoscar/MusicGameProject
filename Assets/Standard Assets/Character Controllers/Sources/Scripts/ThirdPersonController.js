...
//*** my variables *********************************************
var externalSpeed : float;
var applyAirFriction : boolean = false;
...
function Update() {
	...
	var movement = moveDirection * (moveSpeed + externalSpeed) + Vector3 (0, verticalSpeed, 0) + inAirVelocity;
...
function ApplyForceSpeed(In_speed : float, In_vect : Vector3)
{
	...
	moveDirection = In_vect.normalized;
}